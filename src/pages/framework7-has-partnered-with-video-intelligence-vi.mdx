...
![Click “Create New” if you don't have apps here yet](https://cdn-images-1.medium.com/max/5020/1*GAkJTXiI4YbNzMRvd27eDg.png)_Click “Create New” if you don't have apps here yet_

When you already have an app, you need to **add placement f**or this app:

![Click** “Add Placement”** to add new placement](https://cdn-images-1.medium.com/max/5020/1*qqw8Sp_OCAweQjO3BqZnLA.png)_Click** “Add Placement”** to add new placement_
...
![Choose just created placement](https://cdn-images-1.medium.com/max/4984/1*jfnsYTO6PK2FF3VpN0orbw.png)_Choose just created placement_

![Click “copy” near the placement id string to copy id to the clipboard](https://cdn-images-1.medium.com/max/5168/1*K_havZ4kXOBiGTcfR162Dg.png)_Click “copy” near the placement id string to copy id to the clipboard_
