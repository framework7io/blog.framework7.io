url: https://blog.framework7.io/framework7-has-partnered-with-video-intelligence-vi-c16f6705c112
date: Mon Dec 18 2017 18:23:52 GMT+0300 (Москва, стандартное время)
...
![](https://cdn-images-1.medium.com/max/3932/1*nBilrmq-Wl7XBcAu5rlC0Q.png)
...
![Click “Create New” if you don't have apps here yet](https://cdn-images-1.medium.com/max/5020/1*GAkJTXiI4YbNzMRvd27eDg.png)*Click “Create New” if you don't have apps here yet*

When you already have an app, you need to **add placement f**or this app:

![Click** “Add Placement”** to add new placement](https://cdn-images-1.medium.com/max/5020/1*qqw8Sp_OCAweQjO3BqZnLA.png)*Click** “Add Placement”** to add new placement*

![When you create place choose Placement Type: **“Video Interstitial”**](https://cdn-images-1.medium.com/max/5184/1*cubqttSAcOJ4piWbH2hUsw.png)*When you create place choose Placement Type: **“Video Interstitial”***

Ok, after we have placement created we need **placement ID:**

![Choose just created placement](https://cdn-images-1.medium.com/max/4984/1*jfnsYTO6PK2FF3VpN0orbw.png)*Choose just created placement*

![Click “copy” near the placement id string to copy id to the clipboard](https://cdn-images-1.medium.com/max/5168/1*K_havZ4kXOBiGTcfR162Dg.png)*Click “copy” near the placement id string to copy id to the clipboard*
