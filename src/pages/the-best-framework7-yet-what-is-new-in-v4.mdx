url: https://blog.framework7.io/the-best-framework7-yet-what-is-new-in-v4-74b2b467047c
date: Mon Jan 14 2019 17:12:16 GMT+0300 (Москва, стандартное время)
...
<iframe src="https://medium.com/media/074ddb0e1b66080396218265e978eda5" frameBorder="0"></iframe>
...
![Navigation Bars in v3](https://cdn-images-1.medium.com/max/2960/1*W-hDTsenwdQGmuYeoNVHgg.png)*Navigation Bars in v3*

In v4 we unified color scheme for navigation bars in iOS and MD themes to the following:

![Navigation Bars in v4](https://cdn-images-1.medium.com/max/2960/1*VCLIAVqfriplTRdrvLkcEg.png)*Navigation Bars in v4*
...
![Centered Navbar Title in iOS & MD Themes](https://cdn-images-1.medium.com/max/2960/1*g3JJnLGSacaplWRn5OiUAg.png)*Centered Navbar Title in iOS & MD Themes*
...
![Top Tabbar in v4 iOS theme](https://cdn-images-1.medium.com/max/2000/1*MzHcZcfrGKS2t20cepdBJw.png)*Top Tabbar in v4 iOS theme*
...
![](https://cdn-images-1.medium.com/max/2960/1*Dt6Z8e8lmh46b7JfEg4O5A.png)

## Unified Messages Colors

Messages component now has similar color scheme for both iOS & MD themes:

![Messages color scheme in v4](https://cdn-images-1.medium.com/max/2960/1*CYY394W75z7paHVt8syCqQ.png)*Messages color scheme in v4*

## Navbar Goes Large

This is one of the most requested features in Framework7. And now it is available in v4 for both iOS and MD themes.

<iframe src="https://medium.com/media/a2a5d67d91cabb60799959076dd88658" frameBorder="0"></iframe>
...
<iframe src="https://medium.com/media/4f459e6812dd69494c38f54e4c4bc427" frameBorder="0"></iframe>
...
![](https://cdn-images-1.medium.com/max/2960/1*ml-BlONPgMnQrAUn1n7RJw.png)
...
![](https://cdn-images-1.medium.com/max/2000/1*X9tZc_mGlSRtEYrc_2xSTg.gif)
...
![](https://cdn-images-1.medium.com/max/2000/1*aOme48IHHAhjyYdtvV3wsw.gif)
...
![](https://cdn-images-1.medium.com/max/2000/1*-SEuT4csTk0RYSSFafhVww.gif)
...
![](https://cdn-images-1.medium.com/max/3400/1*Qi3A6wBRJ64ibLnk6g6QJg.png)
...
![Touch Ripple effect in v4 iOS theme](https://cdn-images-1.medium.com/max/2000/1*x2je18FD8fOAqcnK0U9s7Q.gif)*Touch Ripple effect in v4 iOS theme*

## Events Bus

As you may aware Framework7 has pretty flexible events system/model. Each instance of Framework7's class (*like main `Framework7()` class or any class-based component like `app.calendar.create()`*) has methods to emit and handle events (`emit`, `on`, `once`, `off`).
...
Instead of maintaining different variations of official templates (*Core/Vue/React * Single View/Tabs/Split View * Web/Cordova/PWA*) it is easier to have one tool that combines all variations.
...
![](https://cdn-images-1.medium.com/max/2264/1*RQtTZ99F-Llz3xv5M-0CQA.png)

![](https://cdn-images-1.medium.com/max/2264/1*Dv0ow2VcaGAy0j8IDkZBOQ.png)

![](https://cdn-images-1.medium.com/max/2264/1*rrw40Ha3J2LOZlmnPolMrQ.png)
...
![](https://cdn-images-1.medium.com/max/2352/1*E71Zw0ZZ62BcNJiyGUTCFA.png)
